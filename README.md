...
- **Botones de arriba**: ❓ abre la guía de uso dentro de la página; 📊 abre tu Google Sheet (el link lo manda el Apps Script solo; también podés fijarlo en `SHEET_URL` de `js/config.js`).
